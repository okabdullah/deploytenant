function (user, context, callback) {
   ...
   * Unknown at 2019-02-12T21:25:26.579Z
   */
  ...
  var config = {
    endpoints: {
      linking: 'https://omarmodern.us8.webtask.io/4cb95bf92ced903b9b84ebedbf5ebffd',
      userApi: auth0.baseUrl + '/users',
      usersByEmailApi: auth0.baseUrl + '/users-by-email'
    },
    token: {
      clientId: 'Z1eg0CnXZIeWQaGu7UJOrcKGZE5kaunO',
      clientSecret: 'pHA-SxKqcKo52V3qR9sQrDMwaFC9p65-Sx2ugnX-CV05SppgRH9sm8AyqNgaImJP',
      issuer: auth0.domain
    }
  };
